...
/*Personal Message: Store a person’s name in a variable, and print a message to that person. Your
 ...
 console.log("Hello Zainab, would you like to learn some python today??",userName);
 
 //Task 3
 /*Name Cases: Store a person’s name in a variable, and then print that person’s name in 
 lowercase, uppercase, and titlecase */
 var userName1:string = "zaini"
 console.log("person's name in lower case",userName1.toLowerCase())
 console.log("person's name in upper case",userName1.toUpperCase())
 console.log("person's name in title case")
 
 //TASK 4
 /*Famous Quote: Find a quote  from a famous person you admire . print the quote and the name of its 
 author. your output should something like the following, including the quotation marks:
 Albert Einstein once said, "A person who never made a mistake never tried anything new." */
  ...
  //TASK 5
  /* Famous Quote 2 : Repeat Excercise 4, but time store the famous person's name in a variable called 
  famous_person. Then compose your message and store it in a new variable called message. Print your 
  message.*/
  var famous_person : string = "prophet PCBUH";
  var message : string = "Founder of islam,greatest of all the prophet "
  console.log( `${famous_person }  : ${message}`)
 
 
  //TASK 6
  /* Stripping Names: Store person name in a variable and include some white space characters at the 
  beginning and end of the name. Make sure you use each character combination,"\t" and "\n", at least
  once, so the whitespace arround the name is displayed. then print the name after stripping the
  white spaces.*/
  var person_name : string = "\tQuaid\n"
  console.log("Name with white spaces:",person_name)
  
  // After stripping
  var strippedName : string = person_name.trim()
  console.log(strippedName)
 
 
 //TASK 7
  /*Number Eight: Write addition,subtraction  ,multiplication,and division operations that each result in 
  number 8. Be sure to enclose your operations in print statements to see the result.
 ...
 console.log( `------------------------------------------------\n`)
  ...
  var message1 : string = "My Favourite Number  "
  console.log(`${message1}is ${fav_number}!`)
 ...
 var length: number = 5; // Length of the rectangle
 var width: number = 3; // Width of the rectangle
 
 var area: number = length * width; // Calculate the area
 
 console.log("The area of the rectangle is: " + area); // Print the result
  ...
  var friendsArray : string[] = ["Tayyaba","Esha","Umaima","Hafsa"]
 friendsArray.forEach((name)=>{
  ...
  person’s name, print a message to them. The text of each message should be the same, but each message
   ...
   var names : string[] = ["Ali","Hassan","Talha","Usman"]
  names.forEach((name)=>{
      console.log(name,"Hello! Hope you have a great day.")
 })
 ...
 //TASK 13
  ...
  var  rides : string[] = ["heavy bike","mountain bike","road bike"]
  rides.forEach((ride)=>{
    console.log("I world love to ride on",ride)
 })
 ...
 //TASK 14
  ...
  var  guestList : string[] = ["Zainab","Rikza","Aiman"]
  guestList.forEach((list)=>{
      console.log("Welcome Home!",list)
  })
 ...
 guestList.forEach((newList)=>{
   console.log("Welcome Home!  Nice to see you here",newList)
 })
 ...
 //TASK 16
  ...
  list. • Print a new set of invitation messages, one for each person in your list. */
    ...
    guestList.unshift("wajeeha")
    guestList.splice(2,0,"Amna")
    guestList.push("Aleena")
    guestList.forEach((new1)=>{
     console.log("Welcome! I found a bigger dinner table",new1)
    })
 ...
 //TASK 17
  ...
  var guest:string[] = ["wajeeha","Zainab","Amna","RikzA","Aiman","Aleena"]
  console.log("I can invite only two people for dinner")
 
 while(guest.length > 2){
   let removeGuest = guest.pop()
   console.log(`Sorry ${removeGuest}, I can invite only two people for dinner`)
  }
 ...
 //TASK 18
  ...
  var place:string[] =["paris","turkey","skardu","Kashmir"]
 ...
 place.reverse()
 console.log(` it's order has changed`,place)
 
 place.reverse()
 console.log("it's back to its original order",place)
 
 place.sort();
 console.log("stored in alphabetical order",place)
 ...
 console.log(`Hi .. This is to inform you that we are inviting ${guestList.length} people to dinner`)
 ...
 //TASK 20
  /*Think of something you could store in a array. For example, you could make a list of mountains,
    rivers, countries, cities, languages, or anything else you’d like. Write a program that creates a
      ...
      var cities:string[] = ['Faisalabad','Lahore','Karachi','islamabad']
      for (let namesOfCities of cities){   // ye "of" ka word tb lgaty jb hmai array ky elements one by 
       console.log(namesOfCities)          // agli sy agli line pr chahiye na ky as it as array ki list
                                           // print ho jay
      }
 ...
 //TASK 22
  ...
  try to make one happen. Change an index in one of your programs to produce an index error. 
    ...
    let numbers = [1,2,3,4]
    console.log(numbers[7])  // accessing an invalid index,will produce an error
 
    console.log(numbers[2]) // accessing index 2 which is valid
 ...
 //TASK 24
  ...
  var string1 = "Zainab"
 var string2 = "zainab"
 console.log(string1==string2);  //Equality with strings
 
 console.log(string1 != string2)  // inquality with strings
 
    var upperCase = "ZAINAB";
   var lowerCase = "zainab"
   console.log(upperCase.toLowerCase()== lowerCase)   // lowerCase function
 
    var num1 = 4
 var num2 = 7
 console.log(num1 == num2)   // numerical equality
 console.log(num1 != num2)   // numerical inequality
 ...
 var b = 9
 var c = 6
 console.log(a < b && b < c)  // using and operator
 console.log(b < c || a > b)  // using or operator
 
    var myArray:number[] = [2,5,6,7,9]
 console.log(myArray.includes(9))  // wheather item is in a array
 console.log(myArray.includes(3))  // wheather item is not in array
 ...
 //TASK 28
    /*Stages of Life: Write an if-else chain that determines a person’s stage of life. Set a value for 
 ...
 var favFruits:string[] = ['mango','orange','peach']
 function fav_Fruits(fruit:string){
   if(fruit == 'mango'){ 
 ...
 var userNames:string[] = ['Eric','john','admin','Alex']
 ...
 • Make sure your comparison is case insensitive. If 'John' has been used, 'JOHN' should not be accepted.*/
    var current_users:string[] = ['Eman','Aini','Sara','Hina','Amna','Aliya']
    var new_users : string[] = ['Sara','Amna','Hiba','Naba','Hania']
    ...
    for (let i=0; i<new_users.length; i++){
     let isNameTaken = current_users.some(
         ...
         if (isNameTaken){
             console.log(`The Name "${new_users[i]}" has already been used. You will need to
 ...
 • Use an if-else chain inside the loop to print the proper ordinal ending for each number.Your output
  ...
  var ordinal_number:any[] = [1,2,3,4,5,6,7,8,9]
  ...
  */
   ...
   var pizaa:string[] = ['fajita','behari kabab','supreme']
   for(let i = 0; i < pizaa.length; i++){
     console.log(pizaa[i])
   }  
   for (let i = 0; i < pizaa.length; i++){
     console.log(`i love ${pizaa[i]} pizza`)
   }
 ...
 // TASK 35
  ...
  Store the names of these animals in a list, and then use a for loop to print out the name of
   each animal. • Modify your program to print a statement about each animal, such as A dog would make
    a great pet. • Add a line at the end of your program stating what these animals have in common. 
 ...
 /* Large Shirts: Modify the make_shirt() function so that shirts are large by default with a
  ...
  make_shirt('Extra large','web developer')
 ...
 function make_album(artist_name:any,album_title:any){
  let newAlbum = {
 ...
 let album1 = make_album('john','letting go')
 let album2 = make_album('Eric','fear of flying')
 let album3 = make_album('jess',"the Daugther's table")
 console.log(album1)
 console.log(album2)
 console.log(album3)
 ...
 //TASK 41
    /* Magicians: Make a array of magician’s names. Pass the array to a function called show_magicians(),
     ...
     var magicians: string[] =['cris','penn','david','lance']
     ...
     // TASK 42
      /* Great Magicians: Start with a copy of your program from Exercise 39. Write a function
       ...
       function show_magician(magicians:string[]) {
         const greatMagician:string[]=magicians.map(magicians=>`the great ${magicians}`)
   ...
   // TASK 43
    ...
    return the new array and store it in a separate array. Call show_magicians() with each array
     to show that you have one array of the original names and one array with the Great added to each
      magician’s name.*/
      make_great(magicians);
      var newArray: string[] =['cris','penn','david','lance']
  ...
  and it should print a summary of the sandwich that is being ordered. Call the function three times,
   using a different number of arguments each time.*/
    function orderSandwich(items:any){
     console.log(`${items} sandwich is being ordered`)
    }
 
    orderSandwich('club')
    orderSandwich('cheese')
    orderSandwich('tomato')
 ...
 function carObjects(manufacturer:any,model:any,quantity:any){
   let car = {
 ...
 var carInfo = carObjects('toyota','color:black','sunroof:true')
 console.log(carInfo)